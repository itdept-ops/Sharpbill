export const LEGAL_BUNDLE_VERSION = "2026-07-21-v3" as const;
export const LEGAL_EFFECTIVE_DATE_ISO = "2026-07-21" as const;
export const LEGAL_EFFECTIVE_DATE = "July 21, 2026" as const;
export const LEGAL_OPERATOR_NAME = "Sharpbill" as const;
export const LEGAL_OPERATOR_LOCATION = "Hillsboro, Oregon, United States" as const;
export const LEGAL_EMAILS = {
  legal: "legal@sharpbill.invalid",
  privacy: "privacy@sharpbill.invalid",
  support: "support@sharpbill.invalid",
} as const;
...
export const LEGAL_DRAFT_WARNING =
  "Owner-selected Oregon terms are populated, but this is not legal advice or a final agreement. Before production use, Sharpbill must obtain qualified counsel review, confirm its complete legal entity and mailing address, and verify or replace the unconfirmed sharpbill.invalid contact mailboxes." as const;
...
export const LEGAL_DOCUMENTS: Record<LegalDocumentKey, LegalDocumentDefinition> = {
  terms: {
    ...
    summary:
      "These terms describe the conditions for accessing and using this deployment of Sharpbill.",
    sections: [
      {
        heading: "1. Parties and scope",
        paragraphs: [
          "These Terms of Service are between Sharpbill (\"Sharpbill,\" \"we,\" \"us,\" or the \"Operator\"), based in Hillsboro, Oregon, United States, and the person or organization using the Sharpbill service (\"you\"). They govern the single-tenant hosted service, websites, interfaces, documentation, and support channels Sharpbill makes available.",
          ...
          "The owner has designated support@sharpbill.invalid for support and legal@sharpbill.invalid for legal notices in this draft, with correspondence addressed to Sharpbill, Hillsboro, Oregon, United States. Before production publication, Sharpbill must verify authorized control and active monitoring of those mailboxes or replace them; until then, they are draft contact details and must not be relied on for time-sensitive notices.",
        ],
      },
      {
        heading: "2. Eligibility and authorized access",
        bullets: [
          "You must be at least 18 years old, able to form a binding agreement, and authorized by Sharpbill or your organization to use the service.",
          ...
          "Promptly use the verified support channel published by Sharpbill if you suspect account compromise or unauthorized access.",
        ],
      },
      {
        heading: "3. Free service, use, and administration",
        paragraphs: [
          "Sharpbill currently provides the service without subscription fees, paid plans, automatic renewals, or purchase commitments. There are therefore no payment, billing, refund, or service-credit terms. Sharpbill will present a replacement agreement before introducing a paid plan.",
      ...
      },
      {
        ...
        paragraphs: [
          "You retain whatever rights you have in content and personal data submitted to the service. You grant Sharpbill the limited rights needed to host, process, transmit, secure, back up, and display that data to operate the service and meet lawful obligations.",
      ...
      },
      {
        ...
        paragraphs: [
          "To the extent permitted by law, an organization on whose behalf the service is used will defend, indemnify, and hold harmless Sharpbill and its owners, personnel, affiliates, licensors, and service providers from third-party claims, damages, losses, judgments, penalties, costs, and reasonable legal fees arising from that organization's submitted data, unauthorized or unlawful use, or material breach of this legal bundle. An individual authorized user acting within assigned permissions does not personally assume the organization's defense obligation; an individual remains responsible for claims caused by that individual's own fraud, willful misconduct, unlawful use, or use outside granted authority. No obligation applies to the extent a claim results from Sharpbill's gross negligence, willful misconduct, or violation of law.",
          "Sharpbill will provide reasonable notice of a covered claim and allow the indemnifying organization or party to control its defense, subject to Sharpbill's right to participate with counsel at its own expense. No settlement may admit fault by Sharpbill or impose any monetary or non-monetary obligation on Sharpbill without Sharpbill's prior written consent.",
        ],
      },
      {
        heading: "11. OREGON CHOICE OF LAW, COURTS, AND GENERAL TERMS",
        paragraphs: [
          "SUBJECT TO ANY NON-WAIVABLE LAW, OREGON LAW GOVERNS THIS LEGAL BUNDLE, WITHOUT REGARD TO CONFLICT-OF-LAW PRINCIPLES. Once Sharpbill publishes a verified legal-notice channel, the parties are encouraged to send written notice there and allow 30 days for a good-faith informal resolution before filing a claim, unless urgent injunctive relief is reasonably necessary.",
  ...
  eula: {
    ...
    summary:
      "This EULA describes the limited right to use the Sharpbill software and interfaces.",
    sections: [
      {
        heading: "1. License grant",
        paragraphs: [
          "Subject to this legal bundle and continued authorization by Sharpbill, you receive a limited, non-exclusive, non-transferable, non-sublicensable, revocable right to access and use the Sharpbill software and documentation solely through the single-tenant deployment made available to you and solely for authorized organizational purposes.",
      ...
      },
      {
        ...
        paragraphs: [
          "Sharpbill may deploy patches, upgrades, security fixes, and feature changes. The software may include third-party and open-source components governed by their own license notices; those licenses control where they conflict with this EULA for the applicable component.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "The software is currently provided without charge and without a service-level agreement, guaranteed support response, maintenance window, uptime commitment, or service credit. After Sharpbill verifies or replaces the draft support mailbox, requests may be sent through the published support channel on a best-effort basis.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The owner designated legal@sharpbill.invalid for license questions and formal notices in this draft, addressed to Sharpbill, Hillsboro, Oregon, United States. That mailbox, domain authority, complete address, and legal-entity name must be verified or replaced before this EULA is published as operative.",
        ],
      },
    ],
  },
  privacy: {
    ...
    summary:
      "This notice explains how a Sharpbill deployment processes personal data and the controls available to users.",
    sections: [
      {
        heading: "1. Operator, roles, and contact",
        paragraphs: [
          "Sharpbill, based in Hillsboro, Oregon, United States, operates this single-tenant service and determines the core purposes and means for account administration, authentication, security, service operation, legal acceptance, support communications, and privacy-request handling. For those data sets, Sharpbill acts as the operator and controller where that legal term applies.",
          "When a separate organization directs the business purposes for profile, directory, workplace, or other organization-submitted data, that organization is ordinarily the controller for those data and Sharpbill may act as its processor or service provider. Roles are fact-specific. Production processing in that role requires a separate signed data-processing agreement covering documented instructions, purpose, data types, duration, confidentiality, security, deletion or return, rights assistance, subprocessors, compliance information, and assessment cooperation; this notice alone is not that agreement.",
          "The owner has designated privacy@sharpbill.invalid for privacy requests, support@sharpbill.invalid for support, and legal@sharpbill.invalid for legal notices in this draft. Before production publication, Sharpbill must verify authorized control and active monitoring of each mailbox or replace it. Postal correspondence should identify Sharpbill, Hillsboro, Oregon, United States; a complete service-of-process address and legal-entity form remain subject to counsel confirmation.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Depending on the data and applicable law, Sharpbill processes data as needed to provide the requested service and perform this agreement, for legitimate interests in administering and securing the service, to comply with law, and to establish or defend legal claims. An organization directing workplace or customer-data use is responsible for its own lawful basis and notices.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Sharpbill does not sell precise location, use it for targeted advertising, or use it to make decisions that produce legal or similarly significant effects.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Sharpbill is based in Oregon and this notice is written for an intended United States-oriented organizational deployment. Onboarding does not technically restrict users by country, so that intended audience is not a geographic control. Exact hosting regions, provider processing locations, and international transfers remain release facts to inventory. The operator should not admit non-U.S. users or intentionally import non-U.S. personal data until the relevant roles, notices, contracts, and transfer safeguards are documented.",
        ],
      },
      {
        heading: "10. Age, changes, and contact",
        paragraphs: [
          "The service is limited to authorized users who are at least 18 years old. Sharpbill does not knowingly permit minors to create or use accounts. Once Sharpbill publishes a verified privacy channel, use it if you believe a person under 18 has provided personal data.",
          "Sharpbill will version material notice changes and provide appropriate notice or renewed acknowledgement before the changed bundle governs a later login. Prior acceptance evidence remains tied to the exact earlier document versions and content digests.",
          "Draft contact details: Sharpbill, Hillsboro, Oregon, United States; privacy@sharpbill.invalid for privacy matters; support@sharpbill.invalid for service help; and legal@sharpbill.invalid for legal notices. The city/state address, Sharpbill name, domain authority, and mailbox control are owner-supplied but unverified. Counsel must confirm the complete legal-entity name and service-of-process address, and the owner must prove authorized control and monitoring of each mailbox or replace it, before production publication.",
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Do not upload personal data about minors or regulated or highly sensitive data unless Sharpbill has expressly approved that data class and implemented the required safeguards, authority, and agreements.",
      ...
      },
      {
        ...
        paragraphs: [
          "The owner designated support@sharpbill.invalid for vulnerability, compromise, unsafe-content, and policy reports in this draft. That mailbox must be verified or replaced before reliance. A report address never grants authorization to test; do not publicly disclose a vulnerability or access data beyond an expressly authorized scope, and obtain written scope from Sharpbill before security testing.",
        ],
      },
      {
        heading: "7. Enforcement",
        paragraphs: [
          "Sharpbill may investigate suspected violations, preserve relevant evidence, limit functionality, revoke sessions, suspend or terminate accounts, and notify an affected organization or lawful authority when appropriate. Responses should be proportionate, documented, and consistent with applicable law and controlling agreements.",
          "If you believe enforcement was mistaken, use the verified support channel published by Sharpbill and include the account, decision, and basis for review. Sharpbill will review the request on a best-effort basis; this policy does not create a guaranteed response time or service-level commitment.",
        ],
      },
    ],
  },
...
export const LEGAL_CANONICAL_SCHEMA = "sharpbill-legal-document/v1" as const;
...
export const LEGAL_DOCUMENT_SHA256: Record<LegalDocumentKey, string> = {
  terms: "37cbe7a0ff06fb3ba8c5914ad33065fd125b9c94b7a46852a9f9ce77643d1891",
  eula: "2bb333bb3d3314edb2cf945c0bc34212cc27d0f7aff35c414b16e4ec60c7cad2",
  privacy: "20f67642f41b1639ddae3eeb19ca32d0372568c8969aaebb5747265ec577d024",
  aup: "b7715b13d4063b6c092fb85b779ed0be07b9a89fab8df5bd64a0f1cd1b015663",
};
